...
class _UploadPlacesState extends State<UploadPlaces> {
  ...
  saveInfo(String downloadUrl) {
    FirebaseFirestore.instance.collection("places").doc(uniqueIdName).set({
      ...
      "nameOfLocation": nameController.text.trim().toUpperCase(),
                ...
                ListTile(
                  ...
                  title: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                          hintText:
                              "Longitude (press the get coordinates button)",
                          hintStyle: TextStyle(color: Colors.grey),
                          border: InputBorder.none),
                    ),
                  ),
                ...
                ListTile(
                  ...
                  title: Container(
                    ...
                    child: TextField(
                      ...
                      decoration: const InputDecoration(
                          hintText:
                              "Lattitude (press the get coordinates button)",
                          hintStyle: TextStyle(color: Colors.grey),
                          border: InputBorder.none),
                    ),
                  ),
